...
public class Map : MonoBehaviour {
    ...
    // this part makes sure that the map will be an island surrounded by water.  
    ...
    // generates the color of the terrain depinding on height. Will also create monument valley-like mountains 
    ...
    void GenerateTerrain()
    {
        ...
        for (int w = 0; w < width; w++)
        {
            for (int l = 0; l < length; l++)
            {
                ...
                // this part is added to make sure the edge of the mountains is also unwalkable. prevents the caracter from moving through the base of the wall
